...
anim_ghillies()
{
	level.scr_anim[ "generic" ][ "prone_idle" ][ 0 ] = %hunted_pronehide_idle_v1;
...
anims()
{
    if (!isdefined(level.scr_goaltime["generic"]))
    {
        level.scr_goaltime["generic"] = [];
    }
...
patrol()
{
    ...
    maps\_patrol::_id_D48D( "h1_patrol_walk_01", level.scr_anim["generic"]["h1_patrol_walk_01"] );
    maps\_patrol::_id_D48D( "h1_patrol_walk_02", level.scr_anim["generic"]["h1_patrol_walk_02"] );
    maps\_patrol::_id_D48D( "h1_patrol_walk_03", level.scr_anim["generic"]["h1_patrol_walk_03"] );
    maps\_patrol::_id_D48D( "h1_patrol_walk_04", level.scr_anim["generic"]["h1_patrol_walk_04"] );
    maps\_patrol::_id_D48D( "h1_patrol_walk_05", level.scr_anim["generic"]["h1_patrol_walk_05"] );
}
