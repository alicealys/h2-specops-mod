...
post_load()
{
    ...
    level.foley.animnode.angles = ( 0, -90, 180 );
...
firing_range_foley_frag()
{
    ...
    level.foley_frag linkto( level.foley, "tag_inhand", ( 0, 0, 0 ), ( 0, 0, 0 ) );
...
_id_C4F7()
{
    ...
    level._id_D177 = spawn( "script_model", ( 0, 0, 0 ) );
...
_id_C324()
{
    ...
    thread common_scripts\utility::play_loopsound_in_space( "emt_alarm_trainer_alert", ( 0, 0, 0 ) );
}
...
_id_BE2D()
{
    ...
    self.base.origin = self._id_B1B1.origin + ( 0, 0, 9.5 );
...
_id_D393( var_0, var_1, var_2 )
{
    ...
    {
        objective_position( var_3.id, ( 0, 0, 0 ) );
        return;
    }
...
_id_D0A1()
{
    ...
    switch ( var_0 )
    {
        ...
        case "training_locals_kneel":
            maps\_utility::gun_remove();
            self._id_CE77 = spawn( "script_model", ( 0, 0, 0 ) );
