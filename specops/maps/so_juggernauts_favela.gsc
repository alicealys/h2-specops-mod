main()
{
	...
	common_scripts\utility::array_call(getentarray("hiding_door_part", "script_noteworthy"), ::delete);
	common_scripts\utility::array_thread(getentarray("hiding_door_part_disconnect", "script_noteworthy"), ::delete_hiding_door_disconnect);
