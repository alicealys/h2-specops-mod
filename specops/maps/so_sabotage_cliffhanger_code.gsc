...
spawn_funcs()
{
    ...
    array_thread( getentarray( "blue_building_smoker", "script_noteworthy" ), ::add_spawn_function, maps\cliffhanger_code::_id_A927 );
    array_thread( getentarray( "blue_building_loader", "script_noteworthy" ), ::add_spawn_function, maps\cliffhanger_code::_id_A927 );
    array_thread( getentarray( "blue_building_smoker", "script_noteworthy" ), ::add_spawn_function, maps\cliffhanger_code::_id_C577 );
    array_thread( getentarray( "blue_building_loader", "script_noteworthy" ), ::add_spawn_function, maps\cliffhanger_code::_id_C577 );
...
stealth_cliffhanger_clifftop()
{
	...
	switch( self.team )
	{
		case "axis":
			...
			self maps\cliffhanger_stealth::_id_C8E3();
			break;
		case "allies":
	}
}
...
{
	music_loop( "mus_cliffhanger_stealth", 2 );
}

stealth_music_busted_loop()
{
	music_loop( "mus_cliffhanger_stealth_busted", 2 );
}

start_truck_patrol()
{
 	array_thread( getentarray( "truck_guys", "script_noteworthy" ), ::add_spawn_function, maps\cliffhanger_stealth::_id_CB92 );
...
explosive_think( exp_struct )
{
	...
	self.planted_model thread playc4effects();
...
blizzard_control()
{
	//maps\_utility::set_vision_set("cliffhanger_blizzard_med", 0);
