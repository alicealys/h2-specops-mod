...
main()
{
	...
	// _id_D3D6::main( "vehicle_blackhawk_minigun_hero" );
...
chopper_init()
{
	...
	if ( 1 )
	{
		...
		chopper_spawner.vehicletype = "blackhawk_minigun";
		chopper_spawner Delete();

		// Spawn in the new	
		chopper = SpawnVehicle( "h2_vehicle_blackhawk_minigun_hero_exterior", "chopper", "blackhawk", start.origin, start.angles );
		chopper.vehicletype = "blackhawk_minigun";
	
		//level thread maps\_vehicle_code::vehicle_init( chopper );
	}
	else
	{
