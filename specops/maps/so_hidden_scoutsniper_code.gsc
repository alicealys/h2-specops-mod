...
ghillie_enemy_resume_moving( stance, move_time )
{
	...
	//self waittill( "goal_changed" ); // never gets notified
...
{
	music_loop( "mus_so_hidden_scoutsniper_stealth_music", 2 );
...
{
	music_loop( "mus_so_hidden_scoutsniper_busted_music", 2 );
