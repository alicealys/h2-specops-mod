...
level.lua["enable_triggered_start"] = createfunction(enabletriggeredstart)
level.lua["enable_triggered_complete"] = createfunction(enabletriggeredcomplete)
level.lua["add_challenge_timer"] = createfunction(addchallengetimer)
